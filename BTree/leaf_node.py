...
class LeafNode:
  def __init__(lSize, p = None, l = None, r = None):
    self.internalNode = p
    self.leftTNode = l
    self.rightTNode = r
  ...
  def addToLeft(self, value, last):
    ...
    for i in range(0, (self.bTNode).count-1):
      ...
      values[(self.bTNode).count-1] = last;
  ...
  def insert(self, value)
    ...
    if(self.bTNode.left and (self.bTNode.left.count < self.bTNode.leafSize)): #not sure what comes after "and"
      ...
      if (self.bTNode.right and (self.bTNode.right.count < self.bTNode.leafSize)): #not sure what comes after "and"
  ...
  def remove(self, value):
    pos = 0;
    for pos in range(0, count): #I don't understand this line
  ...
  def removeWithRightSibling(self, pos):
    if(self.bTNode.right.count > ((self.bTNode.leafSize) +1 )/ 2):
      ...
      for i in range(0, count):
        ...
        self.bTNode.right = setLeftSibling(self.bTNode.left)
      if (self.bTNode.left):
        self.bTNode.left = setRigthSibling(self.bTNode.right)
