...
{  // to be written by students
  ...
  if(ptr) // child merged out of existence
  {
    delete ptr;
    count--;
  ...
  }  // if child merged out of existence
...
BTreeNode* InternalNode::removeChild(int position)
{
...
InternalNode* InternalNode::removeWithLeftSibling()
{
...
InternalNode* InternalNode::removeWithRightSibling(int pos)
{
